...
be a variant or cursive form of \jp{換}. Partial furigana visible alongside
the cartouche label supports the reading \textit{tenkan} (the kana alongside
\jp{転} appears to read \jp{て}, and the following kana are consistent with
\jp{か}), though the annotation is not fully legible at the available scan
resolution. The reading \jp{商内} is confirmed as \textit{akinai} by clear
furigana.}
