...
a losing position. This is a grave error. Even with great capital, if one
buys recklessly and the market moves against him, the losses compound.
Conversely, a trader of modest means who reads the market well and trades
with discipline can accumulate wealth steadily.

The decision to buy or sell should not be made lightly. One should observe
for several days. When the rice price has been falling and reaches a point
where it no longer declines despite bad news---this is the moment to buy.
...
principle predates the Western maxim ``buy when there is blood in the
...
Right: building from a 1,000-ry\=o base purchase through four stages.
Left: the 100-ry\=o sell diagram with title cartouche \jp{萬光商内之圖}.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{diagrams/fig2_tree_scaling.png}
\caption{The scaling diagram: \jp{転愛商内之圖}. A 1,000-ry\=o buying
position builds through four stages to a 2,000-ry\=o selling position.
\textit{Image: Kyoto University Main Library.}}
\label{fig:tree2}
\end{figure}
