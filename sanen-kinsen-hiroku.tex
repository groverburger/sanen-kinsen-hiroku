...
\vspace*{\fill}
\begin{small}\setlength{\parskip}{0.3em}
...
\jp{所蔵：京都大学附属図書館}\\[0.5em]

\noindent\textbf{About This Edition}\\[0.2em]
...
\noindent\textbf{How to Read This Translation}\\[0.2em]
...
The manuscript attributes authorship to Ushida Gonzabur\=o\linebreak
(\jp{牛田権三郎}) and credits Narukawa Takenosuke (\jp{鳴川猛之助}) as
editor and corrector. It belongs to a genre of ``secret market
...
modified, and reattributed across generations; some circulate under the name
of Honma Munehisa (\jp{本間宗久}) of Sakata. The reader should understand
this as a text from a \textit{tradition} rather than a single author's
...
What follows is a direct translation of the complete text.
...
quality grades---good, average, and poor---not geographic regions.
...
simultaneously, indicate a high-probability trade. The trader must observe:
