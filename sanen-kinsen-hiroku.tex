...
\emergencystretch=1.5em  % Allow slightly looser line breaks to prevent overflow
\usepackage{hyperref}
\usepackage{float}
\usepackage{setspace}
\usepackage{lettrine}
...
Zach Booth is the lead software engineer on the SHERPA project at NASA
Ames Research Center, where he works on mission planning for the VIPER
Lunar Rover using Markov Decision Processes (MDPs) and Partially
Observable MDPs (POMDPs). He studies and works with AI systems---including
Claude (Anthropic)---in his daily engineering workflow.
