...
sentiment-reading and final teachings.\\[1em]
...
Zach Booth is a software engineer at NASA Ames Research Center.
Self-taught in Japanese since the age of eighteen and conversational in
the language, he identified this manuscript in the Kyoto University
Rare Materials Digital Archive and recognized that no accurate English
translation existed.

He directed the translation using AI assistance (Claude, Anthropic),
separating transcription from translation, grading each iteration with
an independent reviewer, and publishing the complete audit trail so
that every editorial decision can be checked.
