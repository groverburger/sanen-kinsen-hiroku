...
tables showing staged position-building at the middle star level.
...
10\% gain (\jp{一割}), the accumulated profit yields 30,000+ tawara
[in volume]. The profit is reinvested, reaching 400 ry\=o.
...
positions are calculated at 20 tawara entries, with buying and selling
at each stage following the same proportional discipline as the buying
method above.

[The specific calculations for the half-board method occupy approximately
one page of the manuscript. The figures follow the same staged pattern:
entry, confirmation, addition, compounding, and exit---applied to selling
rather than buying positions.]
