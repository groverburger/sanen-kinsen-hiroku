...
marks in cursive script on aged paper. Some readings are necessarily
approximate.\\[1em]
...
bracketed passages [like this] indicate brief editorial bridges where the
manuscript's structure requires explanation. Everything else is
Ushida's words.
\end{small}
\newpage
...
no evil, speak no evil'' (\jp{見ざる、聞かざる、言わざる})---reinterpreted
...
also bears the label \jp{三猿軍書選} (\textit{Sanen gunsho sen},
``Selection from the Three Monkeys Military/Strategy Books''), framing
the text within a tradition that explicitly borrows the language of
military strategy for market speculation.}
...
selling pressure appears at the ceiling.

Within a cycle of favorable and adverse conditions spanning twelve or
thirteen years, the secret records of the house---the family tradition of
profitable trading arts spanning thirty generations---through the
miraculous art of accumulating wealth with a capital of fifteen thousand
ry\=o across ten degrees of trading, are secretly stored.

This is the family tradition of Ushida Gonzabur\=o.
...
the price of old rice will rise, and one should sell again.
...
should observe for several days. When the rice price has been falling and
reaches a point where it no longer declines despite bad news---this is the
moment to buy. When rice has been rising and ceases to advance despite
favorable reports---this is the moment to sell.
...
so.\tn{This contrarian principle predates the Western maxim ``buy when
there is blood in the streets'' (apocryphally attributed to Baron
Rothschild, first documented in print in the 1890s).}

\jp{禁判}: Those who deal in large quantities and those with small capital
must both observe these rules equally. The method is the same for all.

\jp{禁判}: In the autumn months, when new rice enters the market and the
old rice price adjusts, the trading of the fourth month must be read
carefully. In times of uncertainty, do not commit fully.

\jp{禁判}: When the people of the world (\jp{世の人}) are of one mind
regarding the market, the strong and weak sentiments must be weighed. One
should consider whether the rice has reached a level where the movement
must reverse.
...
decline through summer. The autumn months---seventh, eighth, ninth---are
the buying months. By the year-end, prices recover.
...
buying. The flat price amid universal pessimism signals that the selling is
exhausted. What cannot fall further must eventually rise.
...
\begin{center}
\jp{穂足の録} --- \textit{Hosoku no Roku}\tn{\jp{穂足} literally means
``spike-foot'' or ``ear of grain,'' referring to the visual shape of
...
\caption{Position-scaling tree diagrams from the original manuscript.
Right page: building from a 1,000-ry\=o base purchase (\jp{千十両買})
through four stages to a 500-ry\=o position (\jp{五百両買}). Left page:
the 100-ry\=o sell diagram (\jp{百両売}) and the turnover method
(\jp{転愛商内之圖}), showing how a 1,000-ry\=o buying position scales to
a 2,000-ry\=o selling position.
...
Starting from a base purchase, build the position through numbered stages.
Stage One (\jp{壱}): the initial commitment of capital---a small, probing
entry that tests the market's direction. Stage Two (\jp{弐}): when the
direction is confirmed, a larger addition. Stage Three (\jp{参}): further
addition as confidence grows. Stage Four (\jp{四}): the position reaches
its full size.

The same principle applies in reverse when selling: do not liquidate the
entire position at once but sell in stages, observing the market's reaction
at each step.

\section{The Turnover Method}

[The manuscript includes a second tree diagram (\jp{転愛商内之圖},
\textit{Diagram of Revolving Trading}) showing how a 1,000-ry\=o buying
position scales through four stages (\jp{壱}--\jp{四}) to a 2,000-ry\=o
selling position. The diagram mirrors the structure of Figure~3.1 but
applied to the sell side.]
...
ry\=o worth. As the market reaches its peak, the momentum of the crowd
drives prices beyond fair value. The disciplined trader sells more than he
bought, profiting from the overshoot.
...
to sell at once. Both impulses are the enemy of profit. The disciplined
trader sells when he wishes to hold, and holds when he wishes to sell---going
against his own emotions as well as those of the crowd.

This art is not to be shared lightly. It is passed down within the family
...
patterns of weather and their correlation with the sexagenary
cycle.\tn{The sexagenary cycle (\jp{干支}, \textit{kanshi}) combines the
ten Heavenly Stems and twelve Earthly Branches to produce a sixty-year
cycle. Each year has a unique two-character designation (e.g., \jp{甲子},
\textit{kinoe-ne}).}

\section{Violent Storms}

In certain years, violent storms and market surges are more frequent:
\jp{甲子}, \jp{丁卯}, \jp{丁未}, \jp{甲戌}, \jp{甲申}, \jp{辛卯},
\jp{甲午}. In these years, rice markets experience extreme volatility;
prices may surge two or three times within a single season.

\section{Floods}

Years containing \jp{己} (\textit{tsuchinoto}) in their stem are associated
with water disasters: \jp{己巳}, \jp{己卯}, \jp{己丑}, \jp{己亥},
\jp{己酉}, \jp{己未}. These bring three-year periods of disruption.

\section{Frost and Cold}

Unusual cold damages crops and triggers three-year adverse periods. Rice
prices rise sharply. [The manuscript devotes only a single line to this
topic.]
...
The onset of the plum rain season (\jt{梅雨}{tsuyu}) follows an
...
Associated years: \jp{丙寅}, \jp{丙子}, \jp{庚辰}, \jp{庚寅}, \jp{壬午},
\jp{壬辰}, \jp{丙申}, \jp{丙午}.
...
The patterns of spring tides (\jt{大潮}{\=oshio}) and neap tides
(\jt{小潮}{koshio}) bear on weather prediction. In years of great tidal
difference, storms are more likely. The timing of tides in relation to
planting and harvesting seasons provides further indicators.

\section{Wind}

Wind direction and timing follow their own cycles: \jp{戊申}, \jp{己卯},
\jp{丙辰}, \jp{丁巳}, \jp{庚申}. In years of strong autumn wind, harvest
...
strong signal. Ten thousand unanimous is an extreme. At such moments, the
solitary trader who goes against them has the advantage.
...
their effect. The ordinary rice price level is established over a year, and
only deviations from this level are traded.
...
\item The 20\% level (\jt{二割}{ni-wari}): if rice falls 20\% from its
  high, this is a meaningful correction.
\item The 30\% level (\jt{三割}{san-wari}): a major correction inviting
  careful buying.
\item Within the high range (\jt{高の内}{taka no uchi}): movements here
  are distribution, not accumulation.
\item Sideways movement (\jt{横の平}{yoko no hira}): the market is
  undecided; wait.
\item People's sentiment (\jt{人の気}{hito no ki}): the crowd's mood
  as a contrary indicator.
\item The grand trend (\jt{大勢}{taisei}): the overarching direction
  that governs all shorter movements.
\end{enumerate}

These six observations determine all trading. When wishing to buy, first
check whether the price has already risen 20--30\% from its base. If it has,
the opportunity for buying has passed; wait for the next decline.

All buying and selling should be done proportionally. When buying, think of
mountains---rice is like mountains and water; it naturally rises and falls.
The great mountain does not rise in a day, and neither does the great price
movement. Buy in portions: first a small amount, then add as the direction
confirms.
...
\tn{The source text names four virtues: Benevolence (\jp{仁}), Wisdom
(\jp{智}), Courage (\jp{勇}), and Discipline (\jp{節}). The traditional
Confucian system names five constant virtues (\jp{五常}), the fifth being
...
is unknown from this manuscript. --- The manuscript heading for this
section reads \jp{仁 — 壱首・壱百五拾目}
(\textit{Jin --- Isshu, hyaku goj\=u me}), which appears to mean
``Benevolence---First article; the 150th item.'' This reference to 150
articles (or items) is unexplained in the manuscript and may indicate that
this text is drawn from, or claims to summarize, a larger collection of
trading rules. The relationship to the ``Fifteen Articles'' earlier in the
text is unclear---the numbers 15 and 150 may or may not be connected.}

Buy once, and it returns to its original level. Wait.

When one buys and the price immediately returns to the purchase level, do
not panic and sell at cost. The market is testing the trader's resolve. This
is the test of benevolence---patience and compassion for one's own position.
...
Wisdom in trading has ten aspects:\tn{The source text states ``ten
principles'' (\jp{十}) for this virtue, though the prose that follows
does not enumerate all ten individually.} knowing when to enter, knowing
when to exit, reading the mood of the market, understanding seasonal
patterns, and patience in waiting for the right moment.

\subsection{The Standard of Calm Profit (\jp{平楽定式})}

Buying is done at a set price level; one then holds until the target
selling month. This requires patience: one must not sell early when prices
dip temporarily, nor hold past the target when greed urges more.
...
delay. The timing gap between regional price movements creates
opportunities for the informed trader. The trader who understands this flow
profits from the gap.

When favorable conditions turn and the market reverses, the signs are subtle
at first. The price may stop rising for several days; then a slight decline
sets in. Those who recognize this early transition profit the most.
...
courage is paralysis. [The manuscript devotes only these lines to this
virtue.]

\section{Discipline (\jp{節}, \textit{Setsu})}

Following the method even when emotions urge otherwise. The cautious man who
holds \jt{陸金}{rikukin}\tn{\jp{陸金} literally ``land gold''---stable
reserves kept out of the market, as opposed to capital actively deployed
in trading positions.} of twenty tawara and trades with five will survive
all storms. He who trades with his entire fortune will eventually be
ruined.
...
entry. At 30\% below: the second entry, larger. The total position should
never exceed what can be held for one full year.
...
In the Tenmei era, within the market: old rice is bought beginning in the
third or fourth month, at a level of 130 [units]. Buying at 20 tawara
positions, adjusting at each stage. The buying and selling compounds
...
level, using Osaka market rates (\jp{大坂数位}):

Stage One (\jp{壱}): 100 ry\=o committed, purchasing 20 tawara at the
middle star level. At the Osaka rate, positions of 18 tawara [are held].
This is the probing entry.

Stage Two (\jp{弐}): a further 100 ry\=o committed as direction
confirms---position now 200 ry\=o, approximately 20 tawara held. At a
10\% gain (\jp{一割}), the profit is reinvested. The manuscript
notes \jp{三万余世俵}---``30,000+ world-tawara''---which likely refers to
the total trading volume across all positions in the market cycle, not
a single holding.\tn{The figure \jp{三万余世俵} (30,000+ tawara) and
similar large numbers in these tables appear to represent cumulative
market volume or aggregate position value across the trading period,
rather than a single trader's holding. The manuscript's accounting
method is not fully explained.} The capital reaches 400 ry\=o.

Stage Three (\jp{参}): position built to 300 ry\=o at the middle star
level. At 20\% gain (\jp{弐割}), the position reaches 14 tawara per
100 ry\=o committed. Compounding accelerates; accumulated volume
exceeds 80,000 tawara.

Stage Four (\jp{四}): full position at 400 ry\=o capital committed.
Through compounding at 20\% at each stage, the effective exposure has
grown to approximately 800 ry\=o---doubling the original capital through
disciplined staged entry.

\subsection{Trading with 200 Ry\=o}

\begin{center}
\jp{二百両買} --- \textit{200 Ry\=o Buy}
\end{center}

\vspace{0.5em}

Starting at the middle star level with 200 ry\=o:

Stage One (\jp{壱}): 200 ry\=o committed at 14 tawara. At 10\%
(\jp{一割}), the position grows to reach 19 tawara.

Stage Two (\jp{弐}): 100 ry\=o added---total 300 ry\=o. Holding 14
tawara per 100 ry\=o committed. At the middle star, the accumulated
position reaches 25 tawara.

Stage Three (\jp{参}): Further 100 ry\=o added. The 400 ry\=o total now
commands positions of 800 [ry\=o equivalent] through compounding.
Running total through 19 tawara positions at the middle star.

Stage Four (\jp{四}): Full commitment at 800 ry\=o effective exposure.
The position is squared at a profit, yielding approximately 633 tawara
[\jp{六百三拾三俵}] in accumulated returns.

\subsection{Trading with 300 Ry\=o}

\begin{center}
\jp{三百両買} --- \textit{300 Ry\=o Buy}
\end{center}

\vspace{0.5em}

Stage One (\jp{壱}): 300 ry\=o committed, purchasing 25 tawara at the
middle star level. A strong position (\jp{強氣}) at 10\%
(\jp{一割}).

Stage Two (\jp{弐}): 100 ry\=o added. Holding at 18 tawara per entry.
The position builds through the middle star to 500 ry\=o.

Stage Three (\jp{参}): Further additions bring the total to 800 ry\=o.
At 20\% the position compounds, with 17 tawara reached.

Stage Four (\jp{四}): Full cycle---position of 300 ry\=o yields
[approximately] 800 ry\=o through the staged method. The middle star
level is maintained throughout.

\subsection{Trading with 500 Ry\=o}

\begin{center}
\jp{五百両買} --- \textit{500 Ry\=o Buy}
\end{center}

\vspace{0.5em}

Stage One (\jp{壱}): 100 ry\=o of the 500 committed initially at
15 tawara.

Stage Two (\jp{弐}): 100 ry\=o added, holding 14 tawara. The position
builds at the middle star level.

Stage Three (\jp{参}): A further 100 ry\=o, reaching 800 ry\=o exposure
through compounding at 20\%.

Stage Four (\jp{四}): At the middle star, 14 tawara per stage; 20\%
gain at each level. The full position reaches 800+ ry\=o in accumulated
profit, with positions of approximately 25 tawara.

The key principle holds at every level: the larger the capital base, the
more critical the staged method becomes.

\subsection{Scaling to 1,000 Ry\=o}

\begin{center}
\jp{千両} --- \textit{1,000 Ry\=o}
\end{center}

\vspace{0.5em}

At the 1,000-ry\=o level, the text introduces a five-stage system with
escalating percentage commitments (\jp{顧氣}---``reflecting on
momentum''):

Stage One (\jp{壱}): 1,000 ry\=o over half a year (\jp{半年千両}). First
entry at 10\% (\jp{一割})---committing only 100 ry\=o initially. Half-year
position at 100 ry\=o.

Stage Two (\jp{弐}): at 20\% confirmation (\jp{二割}), add 100 ry\=o.
Half-year at 100 ry\=o. Middle star level maintained. Running total
through 14 tawara positions.

Stage Three (\jp{参}): at 20\%, further 300 ry\=o committed. Half-year
at 300 ry\=o. Position accumulates at the middle star level. 800 ry\=o
effective.

Stage Four (\jp{四}): at 20\%, 500 ry\=o committed. Half-year at 500
ry\=o. The accumulated position reaches 14 tawara at full commitment.
Total effective position: approximately 800 ry\=o in profit across the
staged entries.
...
\begin{center}
\jp{半板売米諸勘定之仕法}\\
\textit{Hanita Urimai Shokanjo no Shihō}
\end{center}

\vspace{0.5em}

The half-board (\jt{半板}{hanita}) method applies to selling positions.
...
At each selling stage, the same proportional discipline applies: sell a
portion, observe the market's reaction, then sell further if the direction
confirms. The buying price and selling price must be considered
together---what matters is not any single trade but the cumulative result
across the full cycle of entry and exit.
...
The seven fortunes are seven conditions that, when all present
simultaneously, indicate a high-probability trade.\tn{The source text
presents these conditions as continuous prose rather than a numbered list.
The seven-item enumeration below is editorially structured from the
flowing text for clarity.} The trader must observe:

\begin{enumerate}[leftmargin=2em]
\item The seasonal cycle is favorable.
\item The price is at or below the middle star.
\item Market sentiment is bearish---the crowd is selling.
\item The harvest forecast supports the position.
\item The momentum of recent days confirms a reversal.
\item One's own capital is sufficient to hold through adversity.
\item The fortune-qi (\jt{運気}{unki}) of the year aligns.
\end{enumerate}

When all seven align, buy with full conviction through the staged method.
...
movement of gold---instead, observe where it concentrates and follow it
there.\tn{The distinction is subtle: ``following gold'' does not mean
following the crowd's \textit{opinion}. It means following the actual flow
of \textit{capital}. The crowd may say one thing while their money does
another.}
...
This is obvious, yet in the heat of trading, men forget this fundamental
law.
...
\caption{The Grand Diagram (\jp{上割三下割之圖}). Center:
\jp{天明古米} (Tenmei-era old rice) with \jp{中豊横} (middle-abundance
horizontal) as the baseline. Twelve positions radiate outward representing
the months. Bottom left: \jp{陰} (Yin) with \jp{八極} (Eight
Poles)---selling positions at 25, 24, 22, 21 tawara levels. Bottom right:
\jp{陽三} (Yang)---buying positions at 14, 17, 18, 19 tawara levels.
Bottom annotation: \jp{平の三割高下の割＝校正補} (``Three-part division
of prices, high and low---revised supplement'').
\textit{Image: Kyoto University Main Library.}}
...
manuscript pages 28--29. The diagram itself is annotated \jp{天明古写本}
(\textit{Tenmei-era source manuscript}), indicating it was copied from
an earlier document and incorporated into this revised edition.}

\subsection{Comprehensive Measurement (\jp{度諸})}

For 700 ry\=o of capital at various configurations: the positions are
mapped through buying and selling levels, with 300 ry\=o held in reserve.
The ground of the trading terrain must be understood---positions are not
merely numbers but represent one's relationship to the market's geography.
...
has stopped falling and begins to creep upward. This is the critical moment
to begin buying.

\section{The Beginning of Weak Qi}

A small decline from a sustained high. People are still bullish. Good news
continues. Yet the price stops rising and begins to soften. This is when
selling should begin.
...
first major drop is rarely the final bottom. After the panic subsides, a
temporary recovery occurs. Then the slower, grinding decline continues to
the true bottom.\tn{This three-phase pattern---sharp drop, bounce, slow
grind---closely resembles Dow Theory's description of bear market stages,
formulated by Charles Dow roughly fifty years later in the 1890s--1900s.}

Patience is required to wait for the true bottom rather than buying the
first panic.

\section{Wind and Rain}

When a storm comes and the ship is at sea, one cannot change the wind. But
one can adjust the sails. Similarly, when market conditions shift suddenly,
one cannot change the conditions, but one can adjust the position.

The four seasons each bring their own storms: in the third month, late
frost damages the seedlings. In the fourth month, the growing season
begins and rainfall patterns must be watched. In the fifth month, the
plum rains end; if they continue past this point, flooding is likely. In
the sixth month, the critical growth period, the typhoon season begins.

The trader who anticipates these storms is rarely caught off guard.

Oil and silk prices follow similar patterns, and these observations apply
...
a base price level. From this level, observations are made month by month.

Osaka's D\=ojima exchange is the central rice market; all other regional
prices reference it.\tn{The text draws on records spanning the Tenmei era
(1781--1789) backward through the H\=oreki (1751--1764) and Meiwa
(1764--1772) periods---roughly a century of market observation.}
Information from Osaka flows outward to the provinces, and the gap between
Osaka and provincial prices creates trading opportunities. The trader in
the provinces who knows the Osaka price has an advantage over one who knows
only local prices.
...
reflects the average. The trader who can read the signs in the fields before
the market knows has the greatest advantage.

\section{The World's Accumulation (\jp{世の中積り之事})}

When rice is expensive, all things become dear. When rice is cheap, the
economy loosens. The lords (\jt{大名}{daimy\=o}) who depend on rice
revenues are affected directly, and their spending in turn affects all
markets.
...
odds in their favor. But even the most learned trader will sometimes be
wrong, and the method of staged entry and proportional trading exists
precisely for this reason: to survive being wrong while maximizing the
benefit of being right.

One should approach the market with the same virtues that govern all of
life:

\jp{仁} --- Benevolence: patience and compassion for one's own errors.

\jp{智} --- Wisdom: study and observation before action.

\jp{勇} --- Courage: acting decisively when the signs align.

\jp{節} --- Discipline: following the method even when emotions urge
otherwise.

The trader who embodies all four virtues will prosper across generations.
The trader who relies on any one alone will eventually fail.
...
merely in the rules but in the understanding behind them. A rule without
understanding is dangerous; understanding without discipline is useless.

To the reader who has studied this record thoroughly: may you trade with
wisdom and prosper.\tn{The closing passages of the manuscript are written
in dense cursive that is particularly difficult to read. The translation
of this afterword may be close paraphrase rather than strictly
word-for-word in places.}
