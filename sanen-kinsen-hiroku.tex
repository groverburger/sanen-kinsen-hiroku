...
The manuscript attributes authorship to Ushida Gonzabur\=o
...
In a year of favorable conditions, the autumn harvest is plentiful; the
highs and lows can be estimated across four seasons. In spring, from around
the fourth month onward, buy at the fifth-month level; by the end of the
year, the high price will come.
...
The following are cautionary judgments (\jt{禁判}{kinban}) for the
marketplace.\tn{The text marks each key rule with the notation \jp{禁判}
(\textit{kinban}), literally ``forbidden judgment''---a cautionary ruling
to be heeded. These function as the core commandments of the trading
method.}

Within the market, one must read the sentiment of the crowd---whether people
are inclined to buy or sell---and not act rashly.

\textit{Cautionary judgment:} The large trader may think that because he has
capital, he can afford to hold a losing position. This is a grave error.
...
\textit{Cautionary judgment:} The decision to buy or sell should not be made
lightly. One should observe for several days. When the rice price has been
falling and reaches a point where it no longer declines despite bad
news---this is the moment to buy. When rice has been rising and ceases to
advance despite favorable reports---this is the moment to sell.

\textit{Cautionary judgment:} Do not follow the crowd blindly. When all are
buying, consider selling; when all are selling, consider buying. The profit
lies in going against common sentiment, yet one must have sound reason for
doing so.\tn{This contrarian principle predates the Western maxim ``buy
when there is blood in the streets'' (apocryphally attributed to Baron
Rothschild, first documented in print in the 1890s).}

\textit{Cautionary judgment:} Those who deal in large quantities and those
with small capital must both observe these rules equally. Wealth does not
excuse recklessness; poverty does not excuse timidity. The method is the
same for all.

\textit{Cautionary judgment:} When all people of the world are of one mind
regarding the market, be suspicious. A crowd is rarely right at the
extremes. When the sentiment is unanimous, the reversal approaches.

\textit{Cautionary judgment:} Do not trade based on hope or fear. Trade
based on what the rice price itself is telling you. The price is the only
truth; rumors and opinions are not to be trusted over the evidence of the
market's own movement.

\textit{Cautionary judgment:} In the autumn months, when new rice enters the
market and the old rice price adjusts, do not attempt to trade both at once.
Choose one and commit to it with the staged method.

\textit{Cautionary judgment:} In the fourth month, when old rice is cheap
and the year's harvest is not yet known, this is the season of uncertainty.
Do not commit fully. Enter with a small position and wait.

\textit{Cautionary judgment:} When rice has been at a low level for many
months and begins to rise, do not sell immediately out of relief. The first
rise from a long bottom is the beginning, not the end.

\textit{Cautionary judgment:} When rice has been at a high level and begins
to fall, do not buy immediately hoping for recovery. The first fall from a
long top is the beginning of the decline, not a temporary dip.

\textit{Cautionary judgment:} Do not hold a losing position out of
stubbornness. If the market has moved against you and the conditions that
justified the original entry no longer hold, exit and wait for a new
opportunity.

\textit{Cautionary judgment:} Do not let a winning position make you
arrogant. The market gives and the market takes. What was gained in one
season can be lost in the next if discipline is abandoned.

\textit{Cautionary judgment:} Gold and rice move in cycles. What rises must
eventually fall; what falls must eventually rise. The trader who remembers
this in both prosperity and adversity will endure.

\textit{Cautionary judgment:} Do not trade in haste. In the Tenmei era,
those who traded with two hundred tenmei of capital and exercised patience
prospered. Those who acted in haste, regardless of their capital, were
ruined.

\textit{Cautionary judgment:} Keep one's own counsel. Do not boast of
profits, for this invites envy. Do not lament losses, for this invites
contempt. Trade quietly, profit quietly, and endure quietly.
...
The upper rice-producing regions (\jt{上作}{j\=osaku}) yield abundantly;
prices are depressed accordingly. The middle regions (\jt{中作}{ch\=usaku})
fall between upper and lower estimates. The lower regions
(\jt{下作}{gesaku}) yield poorly; prices rise.

In a year of favorable conditions, the rice price from the fifth month
through summer trends as follows: if the harvest is expected to be
plentiful, summer rice will be cheap. Buy in the third month or fourth
month at the low, and sell by the middle of the sixth month when the price
has risen.
...
decline through summer. The autumn months---seventh, eighth, ninth---are the
buying months. By the year-end, prices recover.
...
period. The key transitions are the third-to-fourth month, the
sixth-to-seventh month, and the tenth-to-eleventh month.
...
When the spring rice is read alongside the autumn forecast, the full year's
trading plan can be established. The favorable-year trader buys spring and
sells summer; the adverse-year trader buys autumn and sells year-end.

The sentiment of the market (\jp{米來人気筋}) can be read directly from the
monthly price action. Each month has its own character: the third month is
the month of uncertainty; the fifth month reveals the harvest's direction;
the eighth month is the month of commitment; the twelfth month is the month
of settlement.
...
is unknown from this manuscript.}
...
Wisdom in trading: knowing when to enter, knowing when to exit, reading the
mood of the market, understanding seasonal patterns, patience in waiting for
the right moment.
...
holds stable reserves of twenty tawara and trades with five will survive all
storms. He who trades with his entire fortune will eventually be ruined.
...
The rice market at any moment exists within one of three ranges. The upper
level: approximately 35 tawara---the ceiling range where selling is
indicated. The middle level: approximately 30 tawara, 1 bu---equilibrium,
where one observes and waits. The lower level: approximately 25 tawara---the
floor range where buying is indicated.
...
tables showing staged position-building at the middle star level. The
method is demonstrated at 100, 200, 300, 500, and 1,000 ry\=o capital
levels. The following are representative examples.]
...
entry at 10\% (\jp{一割})---committing only 100 ry\=o initially.

Stage Two (\jp{弐}): at 20\% confirmation (\jp{二割}), add 100 ry\=o.
Middle star level maintained. Running total through 14 tawara positions.

Stage Three (\jp{参}): at 20\%, further 300 ry\=o committed. Position
accumulates at the middle star level.
...
profit across the staged entries.

Stage Five (\jp{五}): at 30\% (\jp{三割}), the final stage---the full
cycle is complete.

[The source text continues with further calculation tables at 200, 300,
and 500 ry\=o, all following the same proportional method. The key principle
is constant: never commit the full position at once, and reinvest profits at
each stage to compound returns.]
...
\begin{center}
\jp{三割上下割之圖}\\
\textit{Diagram of the Three-Part Upper and Lower Division}
\end{center}

\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{diagrams/diagram_grand_chart.png}
\caption{The Grand Diagram (\jp{三割上下割之圖}). Center: \jp{中星廿俵}
(Middle Star, 20 tawara). Twelve positions radiate outward representing
the months. Bottom left: \jp{陰} (Yin)---selling positions. Bottom right:
\jp{陽} (Yang)---buying positions. Notation \jp{天明古写本} indicates the
Tenmei-era source. \textit{Image: Kyoto University Main Library.}}
...
opportunities. The trader in the provinces who knows the Osaka price has an
advantage over one who knows only local prices.
