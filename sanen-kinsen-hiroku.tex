...
% --- Epigraph-style block for direct quotations from the source ---
...
\item \textbf{Body text} (this serif typeface) presents translated
  content from the source manuscript. Indented italic passages mark
  direct quotations or maxims where the source language is particularly
  vivid or condensed.
\item
  \begin{editornote}
...
\textit{ch\=oaimai}) was traded as forward contracts.\tn{The D\=ojima
exchange, established in 1697, is often cited as the world's first organized
futures market.}
...
Diagram of the Supreme Ultimate, c.\,1070), grounding market theory in the
highest philosophical authority available.}
...
It anticipates behavioral finance concepts like ``buy when there is blood in
the streets'' (attributed to Baron Rothschild) by roughly a century.}
...
\begin{editornote}
The source text provides extensive numerical examples of position-building
at each level. The following summarizes the method; the original tables
detail specific ry\=o-to-tawara conversions across dozens of stages.
\end{editornote}

Starting from 100 ry\=o, the method compounds through stages:

\begin{enumerate}[leftmargin=2em]
\item \textbf{First entry}: 100 ry\=o committed at the middle star level,
  purchasing approximately 14 tawara.
\item \textbf{Second entry}: another 100 ry\=o as direction confirms---total
  position now 200 ry\=o.
\item \textbf{Third entry}: further addition, bringing total to 300 ry\=o.
\item \textbf{Fourth entry}: full position established at 400 ry\=o, with
  compounding bringing the effective exposure to approximately 800 ry\=o.
\end{enumerate}

The method is then extended to 1,000-ry\=o and larger capital bases, always
...
\item Moss, Michael. ``The Dojima Rice Market and the Origins of Futures
  Trading.'' In \textit{The Origins of Value: The Financial Innovations
  That Created Modern Capital Markets}, edited by William N.\ Goetzmann
  and K.\ Geert Rouwenhorst, 305--322. Oxford: Oxford University Press,
  2005.

\item Nison, Steve. \textit{Japanese Candlestick Charting Techniques}.
  2nd ed. New York: Prentice Hall, 2001.
...
\item Shimamoto, Ryūto. \jp{堂島米市場} (\textit{D\=ojima Kome Shij\=o}
  [The D\=ojima Rice Market]). Tokyo: Kodansha, 2018.
...
\item Zhou Dunyi. \textit{Taijitu shuo} (\jp{太極図説}, Explanation of the
  Diagram of the Supreme Ultimate). c.\,1070. In Wing-tsit Chan, trans.
