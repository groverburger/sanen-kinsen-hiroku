...
\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth]{diagrams/diagram_three_levels.png}
\caption{The Three Levels Diagram (\jp{世の中三段之圖}). The circle is
divided into Upper (\jp{上}), Middle (\jp{中}), and Lower (\jp{下}).
Below: the Ceiling (\jp{天井}), Floor (\jp{底直}), and Middle Star
(\jp{中星}) reference points. \textit{Image: Kyoto University Main Library.}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{diagrams/diagram_grand_chart.png}
...
Poles)---selling positions. Bottom right: \jp{陽} (Yang)---buying
positions. Bottom annotation: \jp{平の三割高下の割＝校正補} (revised
supplement). \textit{Image: Kyoto University Main Library.}}
