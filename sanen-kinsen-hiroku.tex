...
ry\=o\tn{\jp{両} (\textit{ry\=o}): the standard gold coin of the Edo
period, used throughout this text as the unit of trading capital.
\jp{俵} (\textit{tawara}): a bale of rice, the standard unit of measure
for rice trading and price quotation. These two units---gold and
rice---are the basic vocabulary of the manuscript's arithmetic.}
across ten degrees of trading, are secretly stored.
