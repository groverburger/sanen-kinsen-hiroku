...
(\jp{転換商内之圖}), showing how a 1,000-ry\=o buying position scales to
...
(\jp{転換商内之圖}\protect\footnotemark, \textit{Diagram of
...
\label{fig:tree2}
\end{figure}
\footnotetext{The diagram's title cartouche reads \jp{転換商内之圖}
(\textit{tenkan akinai no zu}, ``Diagram of Turnover Trading'').
The cursive form of \jp{換} in the manuscript resembles \jp{愛}, but
partial furigana alongside the cartouche are consistent with \jp{てんかん}
(\textit{tenkan}), and the body text uses \jp{転換の法} (\textit{tenkan no
h\=o}, ``turnover method'') for the same concept. The reading \jp{商内} is
confirmed as \textit{akinai} by clear furigana.}
